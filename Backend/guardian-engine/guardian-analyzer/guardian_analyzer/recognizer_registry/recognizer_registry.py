...
from guardian_analyzer import EntityRecognizer, PatternRecognizer
...
from guardian_analyzer.recognizer_registry.recognizers_loader_utils import (
...
class RecognizerRegistry:
    ...
    def add_recognizers_from_yaml(self, yml_path: Union[str, Path]) -> None:
        ...
        https://github.com/microsoft/presidio/blob/main/guardian-analyzer/guardian_analyzer/conf/example_recognizers.yaml
