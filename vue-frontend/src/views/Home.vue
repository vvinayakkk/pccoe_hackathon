          ...
          <div class="grid gap-8">
            <div class="col-12 md:col-6">
              <FileUpload
                mode="advanced"
                :multiple="true"
                accept="application/pdf,application/*,text/*,video/*,audio/*"
              ...
              <!-- Loading indicator -->
              <div v-if="isProcessingPdf" class="loading-placeholder">
              ...
              <Card>
                ...
                <template #content>
                  <div class="image-preview-container">
                    <div
                      v-if="originalImageUrl || redactedImage"
                    ...
                    >
                      ...
                      <div v-if="isUploading" class="loading-placeholder">
                        <i
                      ...
                      <div
                        v-else-if="redactedImage"
                        class="redacted-image-container"
                      >
...
const fetchStats = async () => {
  try {
    ...
    const response = await axios.get(
      "http://localhost:3500/api/redactions/total"
    );
...
const onFileSelect = async (event: any) => {
  ...
  if (pdfFile) {
    ...
    try {
      ...
      const response = await fetch(analyzePdfUrl, {
        method: "POST",
        body: formData,
      });
      ...
      router.push({
        ...
        query: {
          pdfUrl: pdfUrl,
          analysisData: btoa(JSON.stringify(analysisData)), // Base64 encode the analysis data
        },
      });
    } catch (error) {
...
const onImageUpload = async (event: any) => {
  ...
  try {
    ...
    const response = await fetch(redactImgUrl, {
      method: "POST",
      body: formData,
    });
...
.loading-placeholder {
  ...
  border-radius: 8px;
  background-color: #f8f9fa;
  margin: 1rem 0; /* Same margin as preview-image */
